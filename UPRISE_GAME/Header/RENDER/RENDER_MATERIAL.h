...
namespace PAIN {
	...
	public:
		static std::shared_ptr<std::unordered_map<std::string, int>> MaterialIdLinkDict;
		static std::shared_ptr<std::unordered_map<std::string, std::shared_ptr<PAIN::Model>>> Modeldict;
		static std::shared_ptr<std::vector<PAIN::Material>> mats;
		static std::shared_ptr<std::vector<std::shared_ptr<PAIN::TerrainModel>>> terrains;
