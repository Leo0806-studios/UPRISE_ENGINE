...
#ifdef UPRISEENGINESERIALISATION_EXPORTS
#define UPRISE_SERIALISATION_API __declspec(dllexport)
#define UPRISE_SERIALISATION_API_EXPORTS export
#else
#define UPRISE_SERIALISATION_API __declspec(dllimport)
#define UPRISE_SERIALISATION_API_EXPORTS
#endif // UPRISEENGINESERIALISATION_EXPORTS
